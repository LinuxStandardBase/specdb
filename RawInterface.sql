...
CREATE TABLE `RawInterface` (
  ...
  `RIname` varchar(255) character set latin1 collate latin1_bin NOT NULL,
  `RIunmangled` text,
...
) ENGINE=MyISAM AUTO_INCREMENT=1201149 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2007-08-03  8:17:03
