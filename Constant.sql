...
CREATE TABLE `Constant` (
  ...
  `Ctype` enum('int','long','float','double','longdouble','string','macro','accessor','Unknown','header_depend') NOT NULL default 'Unknown',
...
) ENGINE=MyISAM AUTO_INCREMENT=15614 DEFAULT CHARSET=latin1;
