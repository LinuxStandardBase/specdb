...
CREATE TABLE `Constant` (
  ...
  `Ctype` enum('int','long','float','double','longdouble','string','macro','accessor','protector','flag','Unknown','header_depend') NOT NULL default 'Unknown',
...
) ENGINE=MyISAM AUTO_INCREMENT=17428 DEFAULT CHARSET=latin1;
